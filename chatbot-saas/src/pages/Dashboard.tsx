          ...
          <GridItem>
            <Card>
              <VStack align="start" gap={2}>
                ...
                <Text fontSize="h2" fontWeight="h2" color="contexta.500">1,234</Text>
                <Text fontSize="small" color="contexta.600">+12% vs mês anterior</Text>
              </VStack>
            </Card>
          </GridItem>
          ...
          <GridItem>
            <Card>
              <VStack align="start" gap={2}>
                ...
                <Text fontSize="h2" fontWeight="h2" color="contexta.500">456</Text>
                <Text fontSize="small" color="contexta.600">+8% vs mês anterior</Text>
              </VStack>
            </Card>
          </GridItem>
          ...
          <GridItem>
            <Card>
              <VStack align="start" gap={2}>
                ...
                <Text fontSize="h2" fontWeight="h2" color="contexta.500">94%</Text>
                <Text fontSize="small" color="contexta.600">+3% vs mês anterior</Text>
              </VStack>
            </Card>
          </GridItem>
          ...
          <GridItem>
            <Card>
              <VStack align="start" gap={2}>
                ...
                <Text fontSize="h2" fontWeight="h2" color="contexta.500">14:30</Text>
